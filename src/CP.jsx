        ...
        <div className={styles.profileSection}>
          <div className={styles.profileCard}>
            <div className={styles.profileImg}>
              <img src={GitAvatar} alt="" className={styles.profileImage} />
              <h2 className={styles.name}>shrey71</h2>
            </div>
            <p className={styles.bio}>
              Competitive programming is a fascinating field that involves
              solving complex algorithmic and computational problems within a
              set timeframe. It challenges your problem-solving skills and
              coding proficiency through rigorous and timed contests. I am
              deeply passionate about competitive programming and find it
              incredibly enjoyable. With a{" "}
              <span onClick={rtc} className={styles.red}>
                peak Codeforces rating of 1853
              </span>
              , I am excited about pushing my limits further and am planning to
              participate in prestigious competitions like the{" "}
              <span onClick={icpc} className={styles.red}>
                ICPC
              </span>{" "}
              in the future.
            </p>
            <div className={styles.links}>
              <a href="https://codeforces.com/profile/shrey71">
                <img src={CFLogo} />
                shrey71
              </a>
              <a href="https://atcoder.jp/users/shrey71">
                <img src={ACLogo} />
                shrey71
              </a>
              <a href="https://leetcode.com/u/shreyg-upta/">
                <img src={LCLogo} />
                shreyg-upta
              </a>
              <a href="https://www.codechef.com/users/shrey72">
                <img src={CCLogo} />
                shrey72
              </a>
              <a href="https://codeforces.com/profile/shrey72">
                <img src={CFLogo} />
                shrey72
              </a>
              <a href="https://codeforces.com/profile/shreyg-upta">
                <img src={CFLogo} />
                shreyg-upta
              </a>
            </div>
